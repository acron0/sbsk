...
var vec__25470_25473 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_25474 = cljs.core.nth.call(null,vec__25470_25473,(0),null);
var only_after_25475 = cljs.core.nth.call(null,vec__25470_25473,(1),null);
var db_changed_QMARK__25476 = (cljs.core.some_QMARK_.call(null,only_before_25474)) || (cljs.core.some_QMARK_.call(null,only_after_25475));
if(db_changed_QMARK__25476){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_25474);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_25475);
...
var map__25483 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__25483__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__25483__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__25491 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var event = cljs.core.get.call(null,map__25491__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__23119__auto___25494 = arguments.length;
var i__23120__auto___25495 = (0);
while(true){
if((i__23120__auto___25495 < len__23119__auto___25494)){
args__23126__auto__.push((arguments[i__23120__auto___25495]));

var G__25496 = (i__23120__auto___25495 + (1));
i__23120__auto___25495 = G__25496;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__23127__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq25493){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25493));
});
...
var args__23126__auto__ = [];
var len__23119__auto___25502 = arguments.length;
var i__23120__auto___25503 = (0);
while(true){
if((i__23120__auto___25503 < len__23119__auto___25502)){
args__23126__auto__.push((arguments[i__23120__auto___25503]));

var G__25504 = (i__23120__auto___25503 + (1));
i__23120__auto___25503 = G__25504;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__23127__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__25497_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__25498_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__25498_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq25499){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__25500,G__25501,seq25499__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1473616895947