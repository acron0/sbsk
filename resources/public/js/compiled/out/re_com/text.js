...
var len__23119__auto___24107 = arguments.length;
var i__23120__auto___24108 = (0);
while(true){
if((i__23120__auto___24108 < len__23119__auto___24107)){
args__23126__auto__.push((arguments[i__23120__auto___24108]));

var G__24109 = (i__23120__auto___24108 + (1));
i__23120__auto___24108 = G__24109;
continue;
} else {
}
break;
...
return re_com.text.label.cljs$core$IFn$_invoke$arity$variadic(argseq__23127__auto__);
});

re_com.text.label.cljs$core$IFn$_invoke$arity$variadic = (function (p__24104){
...
var args = map__24105__$1;
var label = cljs.core.get.call(null,map__24105__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var on_click = cljs.core.get.call(null,map__24105__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var width = cljs.core.get.call(null,map__24105__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var class$ = cljs.core.get.call(null,map__24105__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__24105__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__24105__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
var args__23126__auto__ = [];
var len__23119__auto___24114 = arguments.length;
var i__23120__auto___24115 = (0);
while(true){
if((i__23120__auto___24115 < len__23119__auto___24114)){
args__23126__auto__.push((arguments[i__23120__auto___24115]));

var G__24116 = (i__23120__auto___24115 + (1));
i__23120__auto___24115 = G__24116;
continue;
} else {
}
break;
...
var argseq__23127__auto__ = ((((0) < args__23126__auto__.length))?(new cljs.core.IndexedSeq(args__23126__auto__.slice((0)),(0),null)):null);
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(argseq__23127__auto__);
});

re_com.text.title.cljs$core$IFn$_invoke$arity$variadic = (function (p__24111){
...
var args = map__24112__$1;
var label = cljs.core.get.call(null,map__24112__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var level = cljs.core.get.call(null,map__24112__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var underline_QMARK_ = cljs.core.get.call(null,map__24112__$1,new cljs.core.Keyword(null,"underline?","underline?",-1123247603));
var margin_top = cljs.core.get.call(null,map__24112__$1,new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"0.6em");
var margin_bottom = cljs.core.get.call(null,map__24112__$1,new cljs.core.Keyword(null,"margin-bottom","margin-bottom",388334941),"0.3em");
var class$ = cljs.core.get.call(null,map__24112__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__24112__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__24112__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
re_com.text.title.cljs$lang$applyTo = (function (seq24110){
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24110));
});
...
var args__23126__auto__ = [];
var len__23119__auto___24121 = arguments.length;
var i__23120__auto___24122 = (0);
while(true){
if((i__23120__auto___24122 < len__23119__auto___24121)){
args__23126__auto__.push((arguments[i__23120__auto___24122]));

var G__24123 = (i__23120__auto___24122 + (1));
i__23120__auto___24122 = G__24123;
continue;
} else {
}
break;
...
var argseq__23127__auto__ = ((((0) < args__23126__auto__.length))?(new cljs.core.IndexedSeq(args__23126__auto__.slice((0)),(0),null)):null);
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(argseq__23127__auto__);
});

re_com.text.p.cljs$core$IFn$_invoke$arity$variadic = (function (children){
var child1 = cljs.core.first.call(null,children);
var vec__24118 = ((cljs.core.map_QMARK_.call(null,child1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [child1,cljs.core.rest.call(null,children)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,children], null));
var m = cljs.core.nth.call(null,vec__24118,(0),null);
var children__$1 = cljs.core.nth.call(null,vec__24118,(1),null);
...
re_com.text.p.cljs$lang$applyTo = (function (seq24117){
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24117));
});


//# sourceMappingURL=text.js.map?rel=1473616890387