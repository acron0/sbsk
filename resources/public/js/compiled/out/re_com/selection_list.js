...
var args25005 = [];
var len__23119__auto___25008 = arguments.length;
var i__23120__auto___25009 = (0);
while(true){
if((i__23120__auto___25009 < len__23119__auto___25008)){
args25005.push((arguments[i__23120__auto___25009]));

var G__25010 = (i__23120__auto___25009 + (1));
i__23120__auto___25009 = G__25010;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__22032__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__22032__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__22032__auto__)){
...
if(cljs.core.truth_((function (){var and__22032__auto__ = required_QMARK_;
if(cljs.core.truth_(and__22032__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__25015){
...
var args = map__25018__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__25018__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__25018,map__25018__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__25012_SHARP_){
return item_renderer.call(null,p1__25012_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__25018,map__25018__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__25018,map__25018__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__25013_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__25013_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__25018,map__25018__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__25018,map__25018__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__25014_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__25014_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__25018,map__25018__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__23119__auto___25027 = arguments.length;
var i__23120__auto___25028 = (0);
while(true){
if((i__23120__auto___25028 < len__23119__auto___25027)){
args__23126__auto__.push((arguments[i__23120__auto___25028]));

var G__25029 = (i__23120__auto___25028 + (1));
i__23120__auto___25028 = G__25029;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__23127__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__25021){
...
return ((function (map__25022,map__25022__$1,args){
return (function() { 
var G__25030__delegate = function (p__25024){
...
while (G__25031__i < G__25031__a.length) {G__25031__a[G__25031__i] = arguments[G__25031__i + 0]; ++G__25031__i;}
  p__25024 = new cljs.core.IndexedSeq(G__25031__a,0);
} 
return G__25030__delegate.call(this,p__25024);};
G__25030.cljs$lang$maxFixedArity = 0;
G__25030.cljs$lang$applyTo = (function (arglist__25032){
var p__25024 = cljs.core.seq(arglist__25032);
return G__25030__delegate(p__25024);
});
G__25030.cljs$core$IFn$_invoke$arity$variadic = G__25030__delegate;
return G__25030;
})()
;
;})(map__25022,map__25022__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq25020){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25020));
});


//# sourceMappingURL=selection_list.js.map?rel=1473616894150