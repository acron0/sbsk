...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22650__auto__,writer__22651__auto__,opt__22652__auto__){
return cljs.core._write.call(null,writer__22651__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__23509 = o;
(G__23509[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__23511__i < G__23511__a.length) {G__23511__a[G__23511__i] = arguments[G__23511__i + 0]; ++G__23511__i;}
  args = new cljs.core.IndexedSeq(G__23511__a,0);
} 
...
var args = cljs.core.seq(arglist__23512);
return G__23510__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__22032__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__22032__auto__){
var and__22032__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__22032__auto____$1){
var and__22032__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__23517 = jsprops;
(G__23517["defaultValue"] = value);

(G__23517["onChange"] = ((function (G__23517,v,value,on_change){
return (function (p1__23515_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23515_SHARP_);
});})(G__23517,v,value,on_change))
);
...
var vec__23524 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23524,(0),null);
var id = cljs.core.nth.call(null,vec__23524,(1),null);
var class$ = cljs.core.nth.call(null,vec__23524,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___23529 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___23529 == null)){
} else {
var key_23530 = temp__4661__auto___23529;
(jsprops["key"] = key_23530);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__23532 = (new reagent.impl.template.NativeWrapper());
(G__23532["name"] = c);
...
var len__23119__auto___23538 = arguments.length;
var i__23120__auto___23539 = (0);
while(true){
if((i__23120__auto___23539 < len__23119__auto___23538)){
args__23126__auto__.push((arguments[i__23120__auto___23539]));

var G__23540 = (i__23120__auto___23539 + (1));
i__23120__auto___23539 = G__23540;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__23127__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23536){
var G__23537 = cljs.core.first.call(null,seq23536);
var seq23536__$1 = cljs.core.next.call(null,seq23536);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__23537,seq23536__$1);
});
...
break;
default:
var G__23544 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23544;
continue;
...
var n__22959__auto___23547 = a.length;
var i_23548 = (0);
while(true){
if((i_23548 < n__22959__auto___23547)){
(a[i_23548] = reagent.impl.template.as_element.call(null,(a[i_23548])));
...
var a = cljs.core.into_array.call(null,s);
var n__22959__auto___23550 = a.length;
var i_23551 = (0);
while(true){
if((i_23551 < n__22959__auto___23550)){
var val_23552 = (a[i_23551]);
if((cljs.core.vector_QMARK_.call(null,val_23552)) && ((reagent.impl.template.key_from_vec.call(null,val_23552) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23551] = reagent.impl.template.as_element.call(null,val_23552));

var G__23553 = (i_23551 + (1));
i_23551 = G__23553;
continue;
} else {
}
...
var ctx = {};
var vec__23557 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__23557,(0),null);
var derefed = cljs.core.nth.call(null,vec__23557,(1),null);
...
var G__23561 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23561) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23561){
...
//# sourceMappingURL=template.js.map?rel=1473616887729